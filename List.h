...
public:
    ...
    List &operator=(const List &other)
    {
        ...
        for (basic_iterator x = other.begin(); x != other.end(); ++x)
        {
            push_back(*x);
        }
    ...
    iterator insert(const_iterator pos, const T &value)
    {
        ...
        newNode->next = pos.node; // same as (*newNode).next
    ...
    {
        iterator newPosition = iterator(pos.node->next);
